...
#Kayla -there were significant quantile deviations detected here
...
#Kayla- It says that there are significant quantile deviations
...
#Kayla- an error -missing true false value error appears here
...
#Kayla- the same missing value error appeared here
...
#Kayla - missing true false value error
...
#Kayla- quantile deviations detected
...
```{r}
FS_nest_4.mod.red <- glm(SES_nest_4 ~ pland+enn, family = gaussian, data = FS_comps)
...
#Kayla- significant deviations detected
