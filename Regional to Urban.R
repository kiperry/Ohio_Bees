...
write.csv(nbl, file = "Final.26.Regional to Urban_Nulls/nbl.csv")
write.csv(nlec_0, file = "Final.26.Regional to Urban_Nulls/nlec_0.csv")
write.csv(nlec_1, file = "Final.26.Regional to Urban_Nulls/nlec_1.csv")
write.csv(nlec_2, file = "Final.26.Regional to Urban_Nulls/nlec_2.csv")
write.csv(nnest_1, file = "Final.26.Regional to Urban_Nulls/nnest_1.csv")
write.csv(nnest_2, file = "Final.26.Regional to Urban_Nulls/nnest_2.csv")
write.csv(nnest_3, file = "Final.26.Regional to Urban_Nulls/nnest_3.csv")
write.csv(nnest_4, file = "Final.26.Regional to Urban_Nulls/nnest_4.csv")
write.csv(nnest_5, file = "Final.26.Regional to Urban_Nulls/nnest_5.csv")
write.csv(nsoc_1, file = "Final.26.Regional to Urban_Nulls/nsoc_1.csv")
write.csv(nsoc_2, file = "Final.26.Regional to Urban_Nulls/nsoc_2.csv")
write.csv(nsoc_3, file = "Final.26.Regional to Urban_Nulls/nsoc_3.csv")
write.csv(nsoc_4, file = "Final.26.Regional to Urban_Nulls/nsoc_4.csv")
write.csv(nori_0, file = "Final.26.Regional to Urban_Nulls/nori_0.csv")
write.csv(nori_1, file = "Final.26.Regional to Urban_Nulls/nori_1.csv")

write.csv(nbsim, file = "Final.26.Regional to Urban_Nulls/tbeta_sim.csv")
write.csv(nbsne, file = "Final.26.Regional to Urban_Nulls/tbeta_sne.csv")
write.csv(nbsor, file = "Final.26.Regional to Urban_Nulls/tbeta_sor.csv")

write.csv(nfsim, file = "Final.26.Regional to Urban_Nulls/fbeta_sim.csv")
write.csv(nfsne, file = "Final.26.Regional to Urban_Nulls/fbeta_sne.csv")
write.csv(nfsor, file = "Final.26.Regional to Urban_Nulls/fbeta_sor.csv")

# load the output matrices

nbl <- read.csv("Final.26.Regional to Urban_Nulls/nbl.csv", row.names=1)
nlec_0 <- read.csv("Final.26.Regional to Urban_Nulls/nlec_0.csv", row.names=1)
nlec_1 <- read.csv("Final.26.Regional to Urban_Nulls/nlec_1.csv", row.names=1)
nlec_2 <- read.csv("Final.26.Regional to Urban_Nulls/nlec_2.csv", row.names=1)
nnest_1 <- read.csv("Final.26.Regional to Urban_Nulls/nnest_1.csv", row.names=1)
nnest_2 <- read.csv("Final.26.Regional to Urban_Nulls/nnest_2.csv", row.names=1)
nnest_3 <- read.csv("Final.26.Regional to Urban_Nulls/nnest_3.csv", row.names=1)
nnest_4 <- read.csv("Final.26.Regional to Urban_Nulls/nnest_4.csv", row.names=1)
nnest_5 <- read.csv("Final.26.Regional to Urban_Nulls/nnest_5.csv", row.names=1)
nsoc_1 <- read.csv("Final.26.Regional to Urban_Nulls/nsoc_1.csv", row.names=1)
nsoc_2 <- read.csv("Final.26.Regional to Urban_Nulls/nsoc_2.csv", row.names=1)
nsoc_3 <- read.csv("Final.26.Regional to Urban_Nulls/nsoc_3.csv", row.names=1)
nsoc_4 <- read.csv("Final.26.Regional to Urban_Nulls/nsoc_4.csv", row.names=1)
nori_0 <- read.csv("Final.26.Regional to Urban_Nulls/nori_0.csv", row.names=1)
nori_1 <- read.csv("Final.26.Regional to Urban_Nulls/nori_1.csv", row.names=1)

nbsim <- read.csv("Final.26.Regional to Urban_Nulls/tbeta_sim.csv", row.names=1)
nbsne <- read.csv("Final.26.Regional to Urban_Nulls/tbeta_sne.csv", row.names=1)
nbsor <- read.csv("Final.26.Regional to Urban_Nulls/tbeta_sim.csv", row.names=1)

nfsim <- read.csv("Final.26.Regional to Urban_Nulls/fbeta_sim.csv", row.names=1)
nfsne <- read.csv("Final.26.Regional to Urban_Nulls/fbeta_sne.csv", row.names=1)
nfsor <- read.csv("Final.26.Regional to Urban_Nulls/fbeta_sor.csv", row.names=1)
